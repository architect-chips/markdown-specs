...
Configuration Space Bus. (See External Interfaces (hw/v1/hwarch.html#external-interfaces).)

## **DBBIF**

The NVDLA interface to the DBB. (See External Interfaces (hw/v1/hwarch.html#external-interfaces).)

## **IRQ**

Interrupt request. (See External Interfaces (hw/v1/hwarch.html#external-interfaces).)
